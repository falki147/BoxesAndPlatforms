...
/// <summary>
/// Copy of giawa/opengl4csharp Texture class with linear size fix
/// </summary>
namespace BoxesAndPlatforms
{
    public class Texture : IDisposable
    {
        ...
        public OpenGL.Size Size { get; private set; }
        ...
        public Texture(IntPtr pixelData, int width, int height)
            : this(pixelData, width, height, OpenGL.PixelFormat.Bgra, PixelInternalFormat.Rgba8) { }

        public Texture(IntPtr pixelData, int width, int height, OpenGL.PixelFormat format, PixelInternalFormat internalFormat)
        {
            Filename = "Raw Data";
            Size = new OpenGL.Size(width, height);
        ...
        private void LoadBitmap(string filename, bool flipy = true)
        {
            ...
            {
                Size = new OpenGL.Size(image.Width, image.Height);
                ...
                Gl.TexImage2D(TextureTarget, 0, PixelInternalFormat.Rgba8, image.Width, image.Height, 0, OpenGL.PixelFormat.Bgra, PixelType.UnsignedByte, imageData.Scan0);
                Gl.TexParameteri(TextureTarget, TextureParameterName.TextureMagFilter, TextureParameter.Nearest);
                Gl.TexParameteri(TextureTarget, TextureParameterName.TextureMinFilter, TextureParameter.Nearest);
        ...
        private void LoadDDS(string filename)
        {
            ...
            using (BinaryReader stream = new BinaryReader(file))
            {
                ...
                this.Size = new OpenGL.Size(imageData.Width, imageData.Height);

                // Linear size is often broken, don't use it
                ...
                try
                {
                    ...
                    for (int i = 0; i < (imageData.MipmapCount == 0 ? 1 : imageData.MipmapCount); ++i)
                    {
                        ...
                        else
                        {
                            ...
                            Gl.TexImage2D(TextureTarget, i, format, nWidth, nHeight, 0, OpenGL.PixelFormat.Bgra, pixelType, (IntPtr)(pinned.AddrOfPinnedObject().ToInt64() + nOffset));
                        }
